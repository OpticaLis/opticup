...
| 9–22 | Future modules | ⬜ Not started | — | Lab/KDS, branches, WhatsApp, reports, supplier portal, content hub, B2B network, AI support, WooCommerce sync, POS. **M9 (Lab) unblocked** by M7+M8 schema closure — FK to `sub_orders.id` ready. |
