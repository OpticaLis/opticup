...
- בונה פרומפטים מפורטים לצ'אטים משניים (אסטרטגי למודול + מפקח)
...
### מה אתה לא עושה
- לא כותב קוד
- לא נכנס לפרטי implementation (זה של הצ'אט המפקח)
...
### איך הוא עובד בפועל
```
Daniel ←→ צ'אט אסטרטגי ראשי (אתה)     = תכנון והחלטות
Daniel ←→ צ'אט אסטרטגי למודול           = אפיון מפורט per-module
Daniel ←→ צ'אט מפקח                     = פרומפטים ל-Claude Code
...
| **PROJECT_GUIDE.md** | הוראות לצ'אט מפקח | נדבק בצ'אט מפקח |
...
- **4-tier workflow** — הפרדת אחריות מונעת טעויות. אסטרטגי לא כותב קוד, מפקח לא מחליט ארכיטקטורה
- **CLAUDE.md כחוקה** — Claude Code מכבד את הכללים כשהם כתובים שם
- **"בנייה ליד Access"** — ערך מיידי בלי סיכון. לא מחליפים, מוסיפים

### מה לא עובד / לקחים
- **צ'אט מפקח צריך הנחיות מפורשות** — בלי PROJECT_GUIDE הוא לא מבין שהתפקיד שלו לכתוב פרומפטים, לא קוד
