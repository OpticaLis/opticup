...
**Commits:** Incident logged 2026-04-11 in `modules/Module 3.1 - Project Reconstruction/SESSION_CONTEXT.md` Decision Log ("R15 RESOLVED by Architect" + "Broader principle locked by Main").
