...
const T = {
  ...
  // ─── M5 Customers + M6 Prescriptions Phase A+B (2026-05-22) ──
  CUSTOMERS: 'customers', HOUSEHOLDS: 'households',
  HEALTH_FUNDS: 'health_funds', TENANT_LANGUAGES: 'tenant_languages',
  CUSTOMER_NOTES: 'customer_notes', CUSTOMER_DOCUMENTS: 'customer_documents',
  TENANT_SETTINGS: 'tenant_settings', TENANT_NUMBER_COUNTERS: 'tenant_number_counters',
  EYE_EXAMS: 'eye_exams', PRESCRIPTIONS_GLASSES: 'prescriptions_glasses',
  ...
  PRESCRIPTION_TYPES: 'prescription_types', LENS_MANUFACTURERS: 'lens_manufacturers',
  ...
  // ─── M9 Lab Phase A+B (2026-05-23 NIGHT_RUN Track 3) ──────────
  LAB_JOBS: 'lab_jobs', LAB_CATEGORIES: 'lab_categories',
  LAB_COMPENSATION_TIERS: 'lab_compensation_tiers', LAB_NOTES: 'lab_notes',
  SHIPPING_BOXES: 'shipping_boxes', SHIPPING_BOX_ITEMS: 'shipping_box_items',
  LAB_DAMAGE_REASONS: 'lab_damage_reasons', LAB_COURIERS: 'lab_couriers',
  LAB_SUPPLIER_THRESHOLDS: 'lab_supplier_thresholds', LAB_EVENTS_QUEUE: 'lab_events_queue',
};
