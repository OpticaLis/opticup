...
אני מדביק לך 4 קבצים:
1. SECONDARY_CHAT_TEMPLATE_FINAL.md — תפקידך, ה-flow, כללים, פורמט פרומפטים
2. CLAUDE.md — חוקי הפרויקט (Claude Code קורא אותו אוטומטית, אבל אתה צריך להכיר אותו)
3. ROADMAP.md — מפת הפאזות. שים לב: 3.75 מסומנת ✅ אבל לא בוצעה בפועל — זו הפאזה הנוכחית
4. PHASE_3.75_SPEC.md — מה צריך לבנות
קרא את כל הקבצים לעומק.
אחרי שקראת — כתוב את פרומפט הפתיחה לפי סעיף 4 בתבנית (קריאת קבצי התיעוד מה-repo), כדי ש-Claude Code יסכם את המצב הנוכחי לפני שנתחיל לבצע.
