...
| 3 | ⬜ | מעקב חובות ספקים | חשבוניות, תשלומים, דשבורד חובות, מט"ח |
| 4 | ⬜ | סוכן AI | OCR חשבוניות (Claude Vision), התראות, דוחות אוטומטיים |
| 5 | ⬜ | פורטל ספקים | גישת ספק חיצונית, view-only מלאי לפי ספק |
