...
| 44d | debt-doc-actions.js | modules/debt/debt-doc-actions.js | 176 | Document action toolbar + file attach: _editDocAttachMore, _showAttachChoiceModal, _doAttachFiles, _buildDocActionToolbar (OCR only on standalone docs, pending_review toggle), _softDeleteDocument, _togglePendingReview |
