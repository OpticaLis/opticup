...
| 18 | receipt-form.js | modules/goods-receipts/receipt-form.js | 326 | Receipt form setup: file attachment state (_pendingReceiptFiles), multi-doc numbers (_rcptExtraNums, _addRcptExtraNum, _removeRcptExtraNum, _renderRcptExtraNums, getRcptDocumentNumbers), _pickReceiptFile, _initReceiptDropzone, _stageReceiptFile, _renderReceiptFileList, _removeReceiptFileAt, _removeReceiptFile, openExistingReceipt, toggleReceiptFormInputs, searchReceiptBarcode |
...
| 19b | receipt-confirm-items.js | modules/goods-receipts/receipt-confirm-items.js | 201 | Item-level inventory processing: confirmReceiptCore (multi-doc numbers logged, brand_id validation), createNewInventoryFromReceiptItem (uses item qty + product_type) |
