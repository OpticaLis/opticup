...
| 18a | receipt-form-items.js | modules/goods-receipts/receipt-form-items.js | 303 | Receipt item row management: addReceiptItemRow (note row, editable model/size/color on existing items), getReceiptItems (includes note), _toggleRcptNote, _onReceiptStatusChange, updateReceiptItemsStats, addNewReceiptRow, generateReceiptBarcodes |
