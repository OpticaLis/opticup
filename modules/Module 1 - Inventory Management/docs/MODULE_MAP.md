...
| 19d | receipt-ocr.js | modules/goods-receipts/receipt-ocr.js | 347 | OCR integration: initReceiptOCR, _rcptOcrScan, _applyOCRToReceipt (auto-fill supplier via OcrSupplierMatch + PO via OcrPOMatch with confidence hints), _rcptOcrShowSupplierHint, _rcptOcrFC/_rcptOcrAddConfDot, _rcptOcrSuggestPO (fallback PO suggestion), _rcptOcrShowBanner, _rcptOcrPreviewDoc, _rcptOcrUpdateTemplate, receipt-confirmed listener (learns supplier alias + updates ai_has_po_pattern) |
