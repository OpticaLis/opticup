...
| 44d | debt-doc-actions.js | modules/debt/debt-doc-actions.js | 262 | Document action toolbar + file attach: _editDocAttachMore, _showAttachChoiceModal, _doAttachFiles, _buildDocActionToolbar (OCR, linking, folder assign, change type, review toggle, delete), assignToFolder (folder assignment modal), changeDocumentType (PIN-verified), _softDeleteDocument, _togglePendingReview |
