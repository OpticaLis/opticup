...
| 52g | inventory-resize.js | modules/inventory/inventory-resize.js | 95 | Drag-to-resize column widths on #inv-table: initInvResizeHandles (adds handles to th), saves widths to sessionStorage, double-click resets. RTL-aware. Auto-inits via MutationObserver |
