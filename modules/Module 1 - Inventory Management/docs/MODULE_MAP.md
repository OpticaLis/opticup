...
| 18a | receipt-form-items.js | modules/goods-receipts/receipt-form-items.js | 265 | Receipt item row management: addReceiptItemRow (status dropdown with partial_received), getReceiptItems (single barcode per product line, effectiveQty), _onReceiptStatusChange, updateReceiptItemsStats, addNewReceiptRow, generateReceiptBarcodes (ONE barcode per product line regardless of qty) |
