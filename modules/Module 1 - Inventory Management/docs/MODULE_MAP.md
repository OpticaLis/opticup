...
| 44b | debt-doc-edit.js | modules/debt/debt-doc-edit.js | 184 | Document edit modal with AI learning: editDocument (editable form), _editDocCalc (auto-calc VAT/total), saveDocumentEdits (validate+save+AI learn), _learnFromDocumentEdits (compare OCR vs edits, call updateOCRTemplate) |
