...
| 44d | debt-doc-actions.js | modules/debt/debt-doc-actions.js | 222 | Document action toolbar + file attach: _editDocAttachMore, _showAttachChoiceModal, _doAttachFiles, _buildDocActionToolbar (OCR only on standalone docs, pending_review toggle, change type), changeDocumentType (PIN-verified type change), _softDeleteDocument, _togglePendingReview |
| 44d3 | debt-expense-folders.js | modules/debt/debt-expense-folders.js | 178 | Expense folders CRUD: loadExpenseFolders, getExpenseFolders, renderExpenseFolders, toggleExpenseFolders, addExpenseFolder, editExpenseFolder, deleteExpenseFolder, _toggleFolderActive. Cache: window._expenseFoldersCache |
