...
|------|----|---------|---------|
| 0 | Infrastructure Setup | Global docs, module directory, CLAUDE.md update, branching | כלום |
| 1 | CSS Foundation | variables, components, layout, forms, per-tenant theming | פאזה 0 |
