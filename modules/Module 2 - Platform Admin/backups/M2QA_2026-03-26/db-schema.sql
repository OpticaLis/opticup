...
-- Full SQL in: docs/phase5a-storefront-config.sql
-- ============================================================

-- Table: storefront_config (per-tenant, UNIQUE on tenant_id)
-- DB prep for Module 3 (Storefront). No UI yet.
...
-- Migration: seed existing tenants
...
-- create_tenant() updated: Step 11 adds storefront_config row
-- Full updated function in: docs/phase5a-storefront-config.sql (BLOCK 3)
