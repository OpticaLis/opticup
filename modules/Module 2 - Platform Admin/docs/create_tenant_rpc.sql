-- ============================================================
-- Module 2: Platform Admin — create_tenant() RPC
-- Phase 2c: Tenant Provisioning
-- Generated: 2026-03-26
-- Run in: Supabase Dashboard > SQL Editor (service_role)
-- ============================================================
-- Also includes:
--   1. validate_slug() RPC (Phase 2b)
--   2. delete_tenant() RPC (Phase 2d)
--   3. ALTER employees ADD must_change_pin (Phase 2a)
--   4. ALTER tenant_provisioning_log DROP NOT NULL on tenant_id (Phase 2a)
-- ============================================================
...
DECLARE
  v_reserved TEXT[] := ARRAY[
    'admin', 'api', 'www', 'app', 'test', 'demo', 'support',
    'help', 'login', 'signup', 'register', 'billing', 'dashboard', 'platform',
    'status', 'health', 'docs', 'blog', 'mail', 'ftp', 'cdn', 'static'
  ];
BEGIN
  -- 1. Format check: lowercase, digits, hyphens. No leading/trailing hyphen. 3-30 chars.
...
-- ============================================================
-- Phase 2c: create_tenant() RPC
-- ============================================================
-- Creates a complete tenant with:
--   - tenants row
--   - 6 tenant_config entries
--   - 5 roles
--   - 57 permissions
--   - role_permissions mapping (CEO=all, manager=all except admin, etc.)
--   - 1 admin employee with must_change_pin=true
--   - employee_roles (admin → ceo)
--   - 5 document_types
--   - 5 payment_methods
-- Runs in ONE transaction — failure = full rollback.
-- Provisioning log is written client-side (not inside RPC).
-- ============================================================
...
BEGIN
  ...
  -- ⚠️ Count verified: 57 permissions (see note below)
...
-- ============================================================
-- Phase 2d: delete_tenant() RPC (soft delete only)
-- ============================================================
