-- pg_get_functiondef snapshot of register_lead_to_event before M4_LEAD_STATUS_WAITLIST_SYNC edits.
-- Captured 2026-04-28 by opticup-executor for rollback safety (POST_WAITING_LIST_FIXES F1 pattern).
