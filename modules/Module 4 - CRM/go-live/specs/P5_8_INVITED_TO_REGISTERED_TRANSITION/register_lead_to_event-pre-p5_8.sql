-- ROLLBACK REFERENCE — register_lead_to_event RPC body BEFORE P5_8 (Fix A).
-- Captured 2026-04-29 from live Prizma/demo via pg_get_functiondef().
-- If Fix A needs to be rolled back, execute this file verbatim.
...
BEGIN
  ...
  -- Rung 3 auto-move: detect active attendee on a DIFFERENT event in
  -- waiting_list/invited and move them implicitly. send_notification stays
  -- false on the public-form path — no SMS spam since the form already
  -- shows on-screen confirmation.
