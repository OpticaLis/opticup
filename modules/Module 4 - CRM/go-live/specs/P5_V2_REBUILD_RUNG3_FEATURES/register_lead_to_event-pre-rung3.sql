-- pg_get_functiondef snapshot of register_lead_to_event before Rung 3 edits.
-- Captured 2026-04-28 by opticup-executor for rollback safety.
-- This is the post-M4_LEAD_STATUS_WAITLIST_SYNC version (uses sync RPC).
