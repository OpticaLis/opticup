...
| C | OpticPlus migration (5,028 customers + 1,158 leads) | ⬜ deferred | `docs/specs/M5_MIGRATION/` (not yet authored) | Separate SPEC, Daniel-in-loop |
| D | UI — Customer card (5 tabs) | ⬜ deferred | `docs/specs/M5_UI_CUSTOMER_CARD/` (not yet authored) | UI SPEC, Daniel-in-loop for Chrome MCP |
| E | UI — Customer list + create-mode | ⬜ deferred | `docs/specs/M5_UI_CUSTOMER_LIST/` (not yet authored) | UI SPEC, Daniel-in-loop |
