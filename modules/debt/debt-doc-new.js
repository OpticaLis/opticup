  ...
  modal.innerHTML =
    '<div class="modal" style="max-width:480px">' +
      ...
      '<div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">' +
        ...
        '<label>% \u05DE\u05E2"\u05DE<input type="number" id="nd-vat-rate" value="' + (getTenantConfig('vat_rate') || 17) + '" step="0.01" class="nd-field" oninput="calcNewDocTotal()"></label>' +
...
async function saveNewDocument() {
  ...
  if (!_pendingNewDocFiles.length) { setAlert('new-doc-alert', '\u05D7\u05D5\u05D1\u05D4 \u05DC\u05E6\u05E8\u05E3 \u05E7\u05D5\u05D1\u05E5 \u05D7\u05E9\u05D1\u05D5\u05E0\u05D9\u05EA', 'e'); return; }
