// =========================================================
// debt-supplier-detail.js — Supplier Detail Panel: open/close, routing, opening balance (Phase 4g)
// Load after: shared.js, supabase-ops.js, debt-dashboard.js,
//   debt-documents.js, debt-payments.js, debt-returns.js
// Provides: openSupplierDetail(), closeSupplierDetail(), _switchDetailTab(),
//   openSetOpeningBalance(), _saveOpeningBalance(), _savePaymentTerms()
// See also: debt-supplier-tabs.js (sub-tab renderers — load after this file)
// =========================================================
