...
**Last updated:** 2026-05-09 (after M3_REC014_ORPHAN_CLEANUP close — REC-SITE-014 closed; 3-row /test-shortcodes/ DB cleanup + 3-key i18n poweredBy cleanup; item B `_deprecated/` already gone, no-op)
