...
// =========================================================
// Usage:
//   node scripts/install-service.js --key=eyJ... --watch-dir="C:\path\to\sales"
//   node scripts/install-service.js   (interactive prompts)
// =========================================================
...
async function main() {
  ...
  svc.on('start', function () {
    ...
    console.log('To remove:       node scripts/uninstall-service.js');
  });
